...
def to_arff(file_name):

	fileToRead = file_name  #csv file name or absolute path to be open.
	fileToWrite = f"{file_name.split('.')[0]}.arff" #name as how you'll save your arff file.
	relation = "Bio" #how you'll like to call your relation as.
